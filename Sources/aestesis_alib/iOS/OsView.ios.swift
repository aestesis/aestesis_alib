...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  open class OsViewController: UIViewController, MTKViewDelegate {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    func convertState(phase: UITouch.Phase) -> TouchLocation.State {
      switch phase {
      case .began:
      ...
      case .regionEntered, .regionMoved, .regionExited:
        return TouchLocation.State.cancelled
      default:
        return TouchLocation.State.cancelled
      }
    }
  ...
  /*
class Anim : UIView {
    @objc override func draw(_ rin: CGRect) {
        var r = rin
        if let ctx = UIGraphicsGetCurrentContext() {
            var r = rin
            CGContext.setFillColor(ctx, red:1.0, green:0.0, blue:0.0, alpha:1.0);
            CGContext.setStrokeColor(ctx, 1.0, 0.0, 0.0, 1.0);
            CGContext.fillRect(ctx, r);
        }
    }
    override init(frame: CGRect) {
        super.init(frame: frame)
        Timer(period: 1/60, tick: { [weak self] in
 ...
 */
  public class Splash: UIView {
    ...
    public init(frame: CGRect, asset: String) {
      ...
      //self.addSubview(Anim(frame: frame))
    }
