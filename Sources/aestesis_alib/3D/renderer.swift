...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class Mirror: Node3D, @unchecked Sendable {}  // implemented in renderer
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class Renderer: NodeUI, @unchecked Sendable {
    struct RenderInfo {
        var node: Node3D
        var g: Graphics
        var world: Mat4
    ...
    func perspective(scale s: Double = 1) -> Mat4 {
        return Mat4.scale(Vec3(x: s, y: s, z: 0.002))
            * Mat4.perspective(view: Size.unity, angleOfView: ß.π2, near: 0.1, far: 1000)
    }
    ...
    public func render(to g: Graphics, size: Size) {
        if let world = self.world, let camera = self.camera {
            ...
            let perspective =
                self.perspective(scale: size.length / 1400)
                * Mat4.translation(Vec3(size.point(0.5, 0.5)))
    ...
    func render(to g: Graphics, world: Mat4, node: Node3D, opaque: Bool) -> [RenderInfo] {
        ...
        if mirrors.count > 0 {
            ...
            for n in nodes {
                ...
                infos.append(
                    contentsOf: self.render(
                        to: gn, world: n.matrix * world, node: n, opaque: opaque))
            }
            for m in mirrors {
                ...
                for n in nodes {
                    ...
                    infos.append(
                        contentsOf: self.render(
                            to: gn, world: n.matrix * wm, node: n, opaque: opaque))
                }
            }
        } else {
    ...
    static func globals(_ viewport: Viewport) {
        ...
        viewport["3d.depth.lesser"] = DepthStencilState(
            viewport: viewport, mode: .lesser, write: true)
        viewport["3d.depth.greater"] = DepthStencilState(
            viewport: viewport, mode: .greater, write: true)
        viewport["3d.depth.all.nowrite"] = DepthStencilState(
            viewport: viewport, mode: .all, write: false)
        viewport["3d.depth.lesser.nowrite"] = DepthStencilState(
            viewport: viewport, mode: .lesser, write: false)
        viewport["3d.depth.greater.nowrite"] = DepthStencilState(
...
public class RendererView: View, RendererProtocol, @unchecked Sendable {
    public var db: NodeUI {
        return self
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
class RendererBitmap: Bitmap, RendererProtocol, @unchecked Sendable {
    public var db: NodeUI {
        return self
    }
    public var camera: Camera3D? {
    ...
    public func render(_ fn: @escaping (() -> Void)) {
