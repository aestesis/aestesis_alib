...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
open class MaterialOld : NodeRenderer {
    ...
    public init(parent:NodeUI,name:String,blend:BlendMode=BlendMode.opaque,cull:CullMode=CullMode.front,ambient:Color=Color(a:1,l:0.05),diffuse:Color=Color(a:1,l:0.8),specular:Color=Color.white,shininess:Double=40,texture:String="") {
        self.name = name
        self.blend = blend
        self.cull = cull
    ...
    public init(parent:NodeUI,name:String,blend:BlendMode=BlendMode.opaque,cull:CullMode=CullMode.front,ambient:Color=Color(a:1,l:0.05),diffuse:Color=Color(a:1,l:0.8),specular:Color=Color.white,shininess:Double=40,texture:Size) {
        self.name = name
        self.blend = blend
        self.cull = cull
        self.ambient=ambient
    ...
    public func updateBuffer() {
        if let material=material, needsUpdate {
            needsUpdate=false
            let gpu = GPUmaterial(ambient:ambient.infloat4,diffuse:diffuse.infloat4,specular:specular.infloat4,shininess:Float32(shininess))
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class MaterialHeightMap : MaterialOld {
    struct GPUheight {
        var width:Float32;
        var height:Float32;
        var scale:Float32;
    ...
    var buffer:Buffer?
    public init(parent:NodeUI,name:String,blend:BlendMode=BlendMode.opaque,cull:CullMode=CullMode.front,ambient:Color=Color(a:1,l:0.05),diffuse:Color=Color(a:1,l:0.8),specular:Color=Color.white,shininess:Double=40,size:Size,scale:Double,adjustNormals:Double=1.0) {
    ...
    public init(parent:NodeUI,name:String,blend:BlendMode=BlendMode.opaque,cull:CullMode=CullMode.front,ambient:Color=Color(a:1,l:0.05),diffuse:Color=Color(a:1,l:0.8),specular:Color=Color.white,shininess:Double=40,textureSize:Size,heightSize:Size,heightFormat:Texture2D.Format=Texture2D.Format.bgra,scale:Double,adjustNormals:Double=1.0) {
        self.adjustNormals = adjustNormals
        super.init(parent:parent,name:name,blend:blend,cull:cull,ambient:ambient,diffuse:diffuse,specular:specular,shininess:shininess,texture:textureSize)
