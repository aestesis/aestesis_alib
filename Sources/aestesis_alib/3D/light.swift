...
public class Light: Node3D, @unchecked Sendable {
    var buffer: Buffer?
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class PointLight: Light, @unchecked Sendable {
    struct GPU {
    ...
    public init(
        parent: Node3D, position: Vec3, color: Color = Color.white,
    ...
    public override func use(g: Graphics, atIndex index: Int) {
        if let b = buffer {
            if needsUpdate {
                needsUpdate = false
                let gpu = GPU(
                    color: color.infloat4, attenuationConstant: Float32(attenuation.constant),
                    attenuationLinear: Float32(attenuation.linear),
                    attenuationQuadratic: Float32(attenuation.quadratic),
                    position: self.worldMatrix.translation.infloat3)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class DirectionalLight: Light, @unchecked Sendable {
    struct GPU {
        var color: SIMD4<Float>
    ...
    public override func use(g: Graphics, atIndex index: Int) {
        if let b = buffer {
            if needsUpdate {
                needsUpdate = false
                let gpu = GPU(
                    color: color.infloat4, intensity: Float32(intensity),
                    direction: direction.infloat3)
                let ptr = b.ptr.assumingMemoryBound(to: GPU.self)
                ptr[0] = gpu
            }
            g.render.use(fragmentBuffer: b, atIndex: index)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class Bone: Node3D, @unchecked Sendable {
