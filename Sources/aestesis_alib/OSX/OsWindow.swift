...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public class OsWindow: NSWindow {
        ...
        public init(frame: NSRect, title: String, splash: String? = nil) {
            ...
            super.init(
                contentRect: frame,
                styleMask: [
                    .resizable, .closable, .miniaturizable, .titled, .unifiedTitleAndToolbar,
                ],
    ...
    @objc open class OsAppDelegate: NSObject, NSApplicationDelegate {
        ...
        @objc public func application(
            ...
            Debug.warning(
                "application.didRegisterForRemoteNotificationsWithDeviceToken", #file, #line)
        }
        @objc public func application(
            _ application: NSApplication,
            ...
            Debug.warning(
                "application.didFailToRegisterForRemoteNotificationsWithError", #file, #line)
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
