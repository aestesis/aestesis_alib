...
public class Device {
    ...
    public static var modelName:String {
        ...
        uname(&systemInfo)
        let machineMirror = Swift.Mirror(reflecting: systemInfo.machine)
    ...
    public static var screenSize : Size {
        #if os(macOS)
            return Size(NSScreen.main!.frame.size)
        #elseif os(iOS)
    ...
    public static func initialize() {
        ...
        update = DeviceUpdate()
        #endif
        Debug.info("Screen \(Device.screenSize)  scale \(Device.screenScale)")
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    #if os(iOS)
