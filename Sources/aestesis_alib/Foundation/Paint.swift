...
public struct ColorGradient {
    ...
    public func value(_ position: Double) -> Color {
        ...
        let p = max(min(position, keys.last!), keys.first!)
        var i = 0
        while keys[i + 1] < p {
            i += 1
        }
        ...
        let p1 = keys[i + 1]
        let c1 = colors[p1]!
        return c0.lerp(to: c1, coef: (p - p0) / (p1 - p0))
    }
    ...
    public func process(
        source: Bitmap, destination: Bitmap, blend: BlendMode = .opaque, color: Color = .white,
        _ fn: @escaping (RenderPass.Result) -> Void
    ) {
        let b = destination
...
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class Paint: NodeUI, @unchecked Sendable {
    /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public init(
        parent: NodeUI, mode: PaintMode = PaintMode.fill, blend: BlendMode = BlendMode.opaque,
        color: Color? = nil
    ) {
        self.mode = mode
        self.blend = blend
    ...
    public init(
        parent: NodeUI, mode: PaintMode = PaintMode.fill, blend: BlendMode = BlendMode.opaque,
        color: Color = Color.white, bitmap: Bitmap
    ) {
        self.mode = mode
        self.blend = blend
        super.init(parent: parent)
    ...
    public init(
        parent: NodeUI, mode: PaintMode = PaintMode.fill, blend: BlendMode = BlendMode.opaque,
        pattern: Bitmap, scale: Size = Size(1, 1), offset: Point = Point.zero
    ) {
        self.mode = mode
        self.blend = blend
        super.init(parent: parent)
    ...
    public init(
        parent: NodeUI, mode: PaintMode = PaintMode.stroke, blend: BlendMode = BlendMode.opaque,
        color: Color = Color.white, line: Bitmap, strokeWidth: Double = 1
    ) {
    ...
    public func radialGradient(
        center: Point = Point(0.5, 0.5), focal: Point = Point(0.5, 0.5), radius: Double = 0.5,
        colors: ColorGradient
    ) {
        renderer = RenderRadialGradient(
            center: center, focal: focal, radius: radius, colors: colors)
