...
public class Cloud : Node {
    ...
    public func remove(_ key:String) {
        let rid = CKRecord.ID(recordName: key)
    ...
    public func fetchAll(type:String="keyvalue") -> Future {
        ...
        if let db = db {
            ...
            var cblock : ((CKQueryOperation.Cursor?, Swift.Error?) -> Swift.Void)? = nil
            cblock = {  c,err in
                if let c=c {
