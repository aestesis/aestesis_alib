...
import simd
    ...
    extension Mat4 {
        ...
        public static func rotX(_ angle: Double) -> Mat4 {
            ...
            let s = sin(angle)
            return Mat4(
                r0: Vec4(x: 1), r1: Vec4(x: 0, y: c, z: s, w: 0), r2: Vec4(x: 0, y: -s, z: c, w: 0),
                r3: Vec4(w: 1))
        }
        public static func rotY(_ angle: Double) -> Mat4 {
            ...
            let s = sin(angle)
            return Mat4(
                r0: Vec4(x: c, y: 0, z: -s, w: 0), r1: Vec4(y: 1), r2: Vec4(x: s, y: 0, z: c, w: 0),
                r3: Vec4(w: 1))
        }
        public static func rotZ(_ angle: Double) -> Mat4 {
            ...
            let s = sin(angle)
            return Mat4(
                r0: Vec4(x: c, y: s, z: 0, w: 0), r1: Vec4(x: -s, y: c, z: 0, w: 0), r2: Vec4(z: 1),
                r3: Vec4(w: 1))
        }
        public static func rotZ(_ angle: Double, origin: Vec3) -> Mat4 {
            ...
            return Mat4.translation(-origin)
                * Mat4(
                    r0: Vec4(x: c, y: s, z: 0, w: 0), r1: Vec4(x: -s, y: c, z: 0, w: 0),
                    r2: Vec4(z: 1), r3: Vec4(w: 1)) * Mat4.translation(origin)
        }
        ...
        public static func rotation(axis: Vec3, angle: Double) -> Mat4 {
            let c = cos(-angle)
            let s = sin(-angle)
            let t = 1 - c
            ...
            return Mat4(
                r0: Vec4(
                    x: t * ta.x * ta.x + c, y: t * ta.x * ta.y - s * ta.z,
                    z: t * ta.x * ta.z + s * ta.y),
                r1: Vec4(
                    x: t * ta.x * ta.y + s * ta.z, y: t * ta.y * ta.y + c,
                    z: t * ta.y * ta.z - s * ta.x),
                r2: Vec4(
                    x: t * ta.x * ta.z - s * ta.y, y: t * ta.y * ta.z + s * ta.x,
                    z: t * ta.z * ta.z + c), r3: Vec4(w: 1))
        }
        public static func rotation(phi: Double, theta: Double) -> Mat4 {
        ...
        public static func localPerspective(_ p: Double) -> Mat4 {
            return Mat4.scale(Vec3(x: 138, y: 138, z: 0.05))
                * Mat4.translation(Vec3(x: 0, y: 0, z: -100))
                * Mat4.perspective(angleOfView: ß.π * 0.6)
        }
        public static func perspective(angleOfView: Double) -> Mat4 {
            let scale = 1 / tan(angleOfView * 0.5)
            return Mat4(
                r0: Vec4(x: scale), r1: Vec4(y: scale), r2: Vec4(x: 0, y: 0, z: -1, w: -1),
                r3: Vec4(x: 0, y: 0, z: 1, w: 0))
        }
        public static func perspective(
            view: Size, angleOfView: Double, near n: Double, far f: Double
        ) -> Mat4 {
            let scale = 1 / tan(angleOfView * 0.5)
            return Mat4(
                r0: Vec4(x: scale * view.ratio), r1: Vec4(y: scale),
                r2: Vec4(x: 0, y: 0, z: -f / (f - n), w: -1),
                r3: Vec4(x: 0, y: 0, z: -f * n / (f - n), w: 0))
        }
        public static func perspective(
            ...
            return Mat4(
                r0: Vec4(x: x), r1: Vec4(y: y), r2: Vec4(x: ta, y: b, z: c, w: -1),
                r3: Vec4(x: 0, y: 0, z: d, w: 0))
        }
        public static func gpu(size: Size) -> Mat4 {
            let x1 = 2 / size.width
            let y1 = 2 / size.height
            return Mat4.scale(Vec3(x: x1, y: -y1, z: 0.001))
                * Mat4.translation(Vec3(x: -1, y: 1, z: 0.5))
        }
        ...
        public static func lookAt(eye: Vec3, target: Vec3, up: Vec3) -> Mat4 {
            ...
            return Mat4(
                r0: Vec4(x: x.x, y: y.x, z: z.x), r1: Vec4(x: x.y, y: y.y, z: z.y),
                r2: Vec4(x: x.z, y: y.z, z: z.z), r3: Vec4(xyz: (-eye), w: 1))
        }
        public var r0: Vec4 {
            get {
        ...
        public func multiply(_ m: Mat4) -> Mat4 {
            return self * m
        }
    }
#else
    ...
    public struct Mat4: CustomStringConvertible, JsonConvertible {
        ...
        public var description: String {
            return
                "{ r0:\(r0.description),r1:\(r1.description),r2:\(r2.description),r3:\(r3.description)}"
        }
        public var determinant: Double {
            return r0.x * r1.y * r2.z * r3.w - r0.x * r1.y * r2.w * r3.z + r0.x * r1.z * r2.w * r3.y
                - r0.x * r1.z * r2.y * r3.w
                + r0.x * r1.w * r2.y * r3.z - r0.x * r1.w * r2.z * r3.y - r0.y * r1.z * r2.w * r3.x
                + r0.y * r1.z * r2.x * r3.w
                - r0.y * r1.w * r2.x * r3.z + r0.y * r1.w * r2.z * r3.x - r0.y * r1.x * r2.z * r3.w
                + r0.y * r1.x * r2.w * r3.z
                + r0.z * r1.w * r2.x * r3.y - r0.z * r1.w * r2.y * r3.x + r0.z * r1.x * r2.y * r3.w
                - r0.z * r1.x * r2.w * r3.y
                + r0.z * r1.y * r2.w * r3.x - r0.z * r1.y * r2.x * r3.w - r0.w * r1.x * r2.y * r3.z
                + r0.w * r1.x * r2.z * r3.y
                - r0.w * r1.y * r2.z * r3.x + r0.w * r1.y * r2.x * r3.z - r0.w * r1.z * r2.x * r3.y
                + r0.w * r1.z * r2.y * r3.x
        }
        ...
        public func transform(_ v: Vec4) -> Vec4 {
            return Vec4(
                x: v.x * r0.x + v.y * r1.x + v.z * r2.x + v.w * r3.x,
        ...
        public init(_ m: float4x4) {
            self.init(
                r0: Vec4(m.columns.0), r1: Vec4(m.columns.1), r2: Vec4(m.columns.2),
                r3: Vec4(m.columns.3))
        }
        public init(_ m: float3x3) {
            self.init(
                r0: Vec4(xyz: Vec3(m.columns.0), w: 0), r1: Vec4(xyz: Vec3(m.columns.1), w: 0),
                r2: Vec4(xyz: Vec3(m.columns.2), w: 0), r3: Vec4(xyz: Vec3.zero, w: 1))
        }
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        public static var identity: Mat4 {
        ...
        public static func orthographic(
            _ left: Double, right: Double, bottom: Double, top: Double, zNear: Double, zFar: Double
        ) -> Mat4 {
            let ix = 1 / (right - left)
            let iy = 1 / (top - bottom)
            let iz = 1 / (zFar - zNear)
            return Mat4(
                r0: Vec4(x: 2 * ix), r1: Vec4(y: 2 * iy), r2: Vec4(z: -2 * iz),
                r3: Vec4(
                    x: -(right + left) * ix, y: -(top + bottom) * iy, z: -(zFar + zNear) * iz, w: 1)
            )
        }
