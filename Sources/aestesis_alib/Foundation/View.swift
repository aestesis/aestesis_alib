...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
open class View : NodeUI, @unchecked Sendable {
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public struct Layout {
        ...
        public static var fill:Layout {
            return Layout(align:Align.fill)
        }
    }
    ...
    public var needsRedraw = true {
        didSet(redraw) {
            if redraw, let superview = superview {
                superview.needsRedraw = true
            }
        }
    }
    ...
    public func localTo(_ subview:View,_ p:Point) -> Point {          // superview coord to subview coord
        let m = self.matrix(subview).inverse   // why inverted ??
    ...
    public func order(before v:View) {
        if let superview = superview, v != self {
            superview.subviews.remove(at:superview.subviews.firstIndex(of:self)!)
            superview.subviews.insert(self,at:superview.subviews.firstIndex(of:v)!)
        }
    }
    public func order(after v:View) {
        if let superview = superview, v != self {
            superview.subviews.remove(at:superview.subviews.firstIndex(of:self)!)
            superview.subviews.insert(self,at:superview.subviews.firstIndex(of:v)!+1)
        }
    }
