                    ...
                    if newb && view.size.width > 0 && view.size.height > 0 {
                        ...
                        gn.onDone { ok in
                            ...
                            case .success:
                                ...
                                break
                            case .error(let message):
                                Debug.error("View.surface rendering error. \(message)")
                                self.ui {
                                    b.detach()
                                }
                                break
    ...
    public func snapshot(view: View, _ fn: @escaping (Bitmap?) -> Void) {
        ...
        g.onDone { ok in
            ...
            case .success:
                ...
                return
            case .error(let message):
                Debug.error("Viewport.snapshot(\(view.className)): GPU error \(message)")
                fn(nil)
                return
            default:
                fn(nil)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
@preconcurrency public protocol SystemView {
    func focus()
