...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class ShutterView: View, @unchecked Sendable {
    public enum Overlay {
        case none
        case dots
        case squares
    ...
    let fading: Bool
    public init(
        superview: View, layout: Layout, direction: Direction = .horizontal,
        overlay: Overlay = .none, fading: Bool = false
    ) {
        self.fading = fading
            ...
            if content.subviews.count > 1 {
                ...
                case .horizontal:
                    ...
                    for i in 0..<content.subviews.count {
                        let v =
                            2 - min(abs(Double(i) + self.content.position.x / self.size.width), 1)
                ...
                case .vertical:
                    ...
                    for i in 0..<content.subviews.count {
                        let v =
                            2 - min(abs(Double(i) + self.content.position.y / self.size.height), 1)
            ...
            if content.subviews.count > 1 {
                if alpha > 0.01 {
                    ...
                    case .vertical:
                        ...
                        g.fill(
                            rect: Rect(x: x, y: r.w, w: r.w, h: r.h), blend: .alpha,
                            color: Color(a: alpha, rgb: color))
                        for _ in 0..<content.subviews.count {
                            g.fill(
                                rect: Rect(x: x, y: y, w: r.w, h: r.h).scale(0.75), blend: .alpha,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
public class CarouselView: View, @unchecked Sendable {
